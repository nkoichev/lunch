...
export const GOOGLE_SHEETS_CONFIG = {
  spreadsheetId: '1Uj_mn4WmRdeHeB51--az4bq7-sOZuVBDJZH-xlnPOeQ',
  apiKey: 'YOUR_API_KEY_HERE', // You'll need to create a Google API key

  // Service account credentials (for backend proxy - see README)
  serviceAccount: {
